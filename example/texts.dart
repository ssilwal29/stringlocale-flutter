...
final errorGeneric =
    staticText('error_generic', 'Something went wrong. Please try again.');
...
final websiteStatus = dynamicText(
  ...
  'Website status: {status}',
  {
    'status': const Param('status',
        kind: ParamKind.translatable, context: 'website publishing status'),
  },
);
...
final websiteAudience = dynamicText(
  ...
  {
    'owner': ParamKind.literal,
    'region': const Param('region',
        kind: ParamKind.translatable, context: 'website visitor region'),
  },
);
...
final updatedRelative = dynamicText(
  'updated_relative',
  'Updated {when}',
...
final websiteNote = dynamicText(
  'website_note',
  'Note: {note}',
  {'note': ParamKind.user},
);

final websiteSummary = dynamicText(
  'website_summary',
  'Summary: {summary}',
  {
